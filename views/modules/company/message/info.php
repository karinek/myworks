  ...
  <form action="<?= base_url() ?>message/search/" class="contacts_search_form" method="post">
                            ...
                            <div class="search">
                             ...
                             <ul class="contacts_menu">
                                     ...
                                     <li class="delete" style="border-left: 1px solid #BBBBBB;"><a href="#" id="delete"><i class="delete_img"></i><span>Delete</span></a></li>
                                </ul>

                            <div style="margin-top: 45px;">
                                <p>From : <strong><?= $fromCompany ?></strong></p>
                                ...
                                <strong><a class="email_contact" href="<?php echo base_url(); ?>contact/replay_message/<?= $hidden_id ?>">Contact Company</a></strong>
                            </div>
                         ...
                         <ul class="contacts_menu" style="margin-top:20px;">
                                    ...
                                    <li class="delete" style="border-left: 1px solid #BBBBBB;"><a href="#"><i class="delete_img"></i><span>Delete</span></a></li>
                                </ul>
