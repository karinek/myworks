  ...
  <form action="<?= base_url() ?>message/search/" class="contacts_search_form" method="post">
                            ...
                            <?php foreach ($messageInfo as $message) { 
                                ...
                                <div class="contact_line" style="cursor: pointer">
                                    ...
                                    <div class="from_block"><p><a href="<?= base_url() ?>message/info/<?= $message['id']; ?>"><?= $message['from_company'] ?></a></p></div>
                                    <div class="subject_block"><p><a href="<?= base_url() ?>message/info/<?= $message['id']; ?>"><?= $message['subject'] ?></a><a style="float: right;width: 15px;height: 18px;cursor: pointer" target="_blank" href="<?= base_url() ?>files/message/<?= $message['path'] ?>">   </a></p></div>
