...
<? foreach ($messageInfo as $message) { 
       if($message['userid'] == $user_id)
                                ...
                                <div class="contact_line" style="cursor: pointer">
                                    ...
                                    <div class="subject_block"><p><a href="<?= base_url() ?>message/<?=$action?>/<?= $message['id']; ?>"><?= $message['subject'] ?></a></p></div>
                                    <div class="date_block"><p><a href="<?= base_url() ?>message/<?=$action?>/<?= $message['id']; ?>"><?= date('d.m.Y', strtotime($message['date'])) ?></a></p></div>
                                </div>
