 ...
 <ul class="contacts_menu" style="float:right;">
  ...
  <form action="<?= base_url() ?>message/search/" class="contacts_search_form" method="post">
                            ...
                            <div class="contacts_block_main_head">
                                <div class="from_head">To:</div>
                                <div class="subject_head">Subject:</div>
                            ...
                            <? foreach ($messageInfo as $message) { ?> 
                                <div class="contact_line" style="cursor: pointer">
                                    ...
                                    <div class="from_block"><p><a href="<?= base_url() ?>message/outinfo/<?= $message['id']; ?>"><?= $message['to_company'] ?></a></p></div>
                                    <div class="subject_block"><p><a href="<?= base_url() ?>message/outinfo/<?= $message['id']; ?>"><?= $message['subject'] ?></a><a style="float: right;width: 15px;height: 18px;cursor: pointer" href="<?= base_url() ?>files/message/<?= $message['path'] ?>">  </a></p></div>
                                    <div class="date_block"><p><a href="<?= base_url() ?>message/outinfo/<?= $message['id']; ?>"><?= date('d.m.Y', strtotime($message['date'])) ?></a></p></div>
                                </div>
